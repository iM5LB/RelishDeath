// GitBook-style Documentation System for RelishDeath
...
const PAGES = [
  ...
  { file: 'StashSystem.md', title: 'Stash', section: 'Features', icon: '🎒' },
  { file: 'BlackMarket.md', title: 'Black Market', section: 'Features', icon: '🛒' },
  { file: 'Backups.md', title: 'Admin Backups', section: 'Features', icon: '💾' },
